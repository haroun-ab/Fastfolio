           ...
           signupForm[i].onchange = () => {
               ...
               if (isSignupFirstNameConform && isSignupLastNameConform && isSignupEmailConform && isSignupPasswordConform && isSignupBirthDateConform){
                   ...
                   signupForm.onsubmit = async (e) => {            
                       ...
                       try {
                           const response = await fetch(`${process.env.REACT_APP_DOMAIN_API}/api/signup`, {
                               method: 'POST',
                               headers: {
...
<Modal className="signup-modal" content={    
    <div className="flex-center-column">
        ...
        <p className="indication">If you don’t have an account, <a className="link" href="#" onClick={openLoginModal}>sign in !</a></p>
    </div> 
}/>
